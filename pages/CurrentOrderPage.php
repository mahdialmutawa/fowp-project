...
<head>
    ...
    <style>
        /* Hide elements with display: none and visibility: hidden */
        #OrderContainer {
            display: none;
            visibility: hidden;
        }
    ...
    <section id="TheMainSection"  >
        <div id="current_order_section " >
            <div id="OrderContainer">
                <!-- Hidden elements above "تم الاستلام" -->
            ...
            <div id="rating" >
                <div id="MerchantRating">
                    ...
                    <form id="MerchantForm">
                        <textarea name="MerchantComment" id="MerchantComment" cols="80" rows="10"
                ...
                <div id="ProductRating">
                    <div id="MerchantRating">
                        ...
                        <form id="ProductForm">
                            <textarea name="ProductComment" id="ProductComment" cols="80" rows="10"
                                placeholder="اكتب تعليقك هنا..."></textarea>
                        </form>
                    </div>
                </div>
            ...
            <div id="submitDiv">
                <form id="submitButton" style = "margin: 0 24%;">
